...
function RawLabel(props3) {
  ...
  return import_react4.default.createElement(import_react4.default.Fragment, null, optional2 && import_react4.default.createElement(OptionalToggle, null), hint !== void 0 ? import_react4.default.createElement(Root32, null, import_react4.default.createElement(Trigger, {
    asChild: true
  }, import_react4.default.createElement(StyledLabel, _extends({}, htmlFor, props3))), import_react4.default.createElement(Content2, {
    side: "top",
    sideOffset: 2
  }, import_react4.default.createElement(StyledToolTipContent, null, hint, import_react4.default.createElement(ToolTipArrow, null)))) : import_react4.default.createElement(StyledLabel, _extends({}, htmlFor, title, props3)));
}
function Label(_ref) {
  let {
    align
...
function useDeepMemo(fn, deps) {
  return (0, import_react10.useMemo)(fn, useCompareMemoize(deps, true));
}
...
var LevaCore = import_react10.default.memo(({
  ...
  globalStyles();
  return import_react10.default.createElement(PanelSettingsContext.Provider, {
    value: {
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          render(import_react10.default.createElement(Leva, {
            isRoot: true
          }), rootEl);
        }
      }
