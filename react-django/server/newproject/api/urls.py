...
urlpatterns = [
    ...
    path('update-bg/<uuid:user_id>/<str:bg_name>/', views.update_bg_selected,name='update_bg_selected'),
    path('get-bg/<uuid:user_id>/',views.get_bg_selected,name='get_bg_selected')
]